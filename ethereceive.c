 ...
 *     Receiver file: The user running this file will be the first one to receive a message. After receiving the data, this user can send a message.
...
int snd() 
{
	...
	/*other host MAC address*/
	unsigned char dest_mac[6] = {0xA1, 0xB1, 0xC1, 0xD1, 0xE1, 0xF1};
